...
final class Array_hx implements \JsonSerializable, \Countable, \IteratorAggregate, \ArrayAccess {
	...
	public static function wrap ($arr) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:270: characters 3-23
		$a = new Array_hx();
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:271: characters 3-14
		$a->arr = $arr;
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:272: characters 3-31
		$a->length = count($arr);
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:273: characters 3-11
		return $a;
	}
	...
	public function count () {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:260: characters 3-16
		return $this->length;
	}
	...
	public function getIterator () {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:253: characters 3-38
	...
	public function jsonSerialize () {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:266: characters 3-13
		return $this->arr;
	}
	...
	public function &offsetGet ($offset) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:218: lines 218-224
		if (($offset < 0) || ($offset >= $this->length)) {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:221: characters 4-24
			$result = null;
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:222: characters 4-26
			;
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:223: characters 4-17
			return $result;
		}
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:225: characters 3-21
	...
	public function offsetSet ($offset, $value) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:231: lines 231-236
		if ($this->length <= $offset) {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:232: characters 13-19
			$_g = $this->length;
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:232: characters 22-32
			$_g1 = $offset + 1;
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:232: lines 232-234
			while ($_g < $_g1) {
				#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:232: characters 13-32
				$i = $_g++;
				#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:233: characters 5-18
				$this->arr[$i] = null;
			}
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:235: characters 4-23
			$this->length = $offset + 1;
		}
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:237: characters 3-22
		$this->arr[$offset] = $value;
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:238: characters 3-35
		return $value;
	}
	...
	public function offsetUnset ($offset) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:244: lines 244-247
		if (($offset >= 0) && ($offset < $this->length)) {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:245: characters 4-39
			array_splice($this->arr, $offset, 1);
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:246: characters 4-12
			--$this->length;
		}
	}
