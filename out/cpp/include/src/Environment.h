...
class HXCPP_CLASS_ATTRIBUTES Environment_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct( ::src::Environment parent);
		...
		static ::hx::ObjectPtr< Environment_obj > __new( ::src::Environment parent);
		static ::hx::ObjectPtr< Environment_obj > __alloc(::hx::Ctx *_hx_ctx, ::src::Environment parent);
		...
		::String __ToString() const { return HX_("Environment",b3,a3,82,91); }
		 ...
		 ::src::Environment parent;
		void define(::String name, ::src::types::Value value);
		::Dynamic define_dyn();

		void assign(::String name, ::src::types::Value value);
		::Dynamic assign_dyn();

		 ::src::types::Value get(::String name);
		::Dynamic get_dyn();
