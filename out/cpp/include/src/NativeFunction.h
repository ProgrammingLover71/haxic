...
#define INCLUDED_src_NativeFunction
...
HX_DECLARE_CLASS1(src,NativeFunction)
...
class HXCPP_CLASS_ATTRIBUTES NativeFunction_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x4c1a77ef };

		void __construct(::String name,::Array< ::Dynamic> params, ::Dynamic body);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="src.NativeFunction")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"src.NativeFunction"); }
...
#endif /* INCLUDED_src_NativeFunction */ 
