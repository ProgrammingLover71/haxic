...
class TokenType_obj : public ::hx::EnumBase_obj
{
	...
	public:
		...
		static ::src::TokenType ARROW;
		static inline ::src::TokenType ARROW_dyn() { return ARROW; }
		...
		static ::src::TokenType LBRACE;
		static inline ::src::TokenType LBRACE_dyn() { return LBRACE; }
		...
		static ::src::TokenType PERIOD;
		static inline ::src::TokenType PERIOD_dyn() { return PERIOD; }
		static ::src::TokenType PLUS;
		static inline ::src::TokenType PLUS_dyn() { return PLUS; }
		static ::src::TokenType RBRACE;
		static inline ::src::TokenType RBRACE_dyn() { return RBRACE; }
