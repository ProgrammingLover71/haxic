...
::src::TokenType TokenType_obj::ARROW;
...
::src::TokenType TokenType_obj::LBRACE;
...
::src::TokenType TokenType_obj::PERIOD;

::src::TokenType TokenType_obj::PLUS;

::src::TokenType TokenType_obj::RBRACE;
...
{
	if (inName==HX_("ARROW",a9,b1,7d,a3)) { outValue = TokenType_obj::ARROW; return true; }
	...
	if (inName==HX_("LBRACE",87,c1,f6,99)) { outValue = TokenType_obj::LBRACE; return true; }
	...
	if (inName==HX_("PERIOD",01,0d,9e,ed)) { outValue = TokenType_obj::PERIOD; return true; }
	if (inName==HX_("PLUS",5a,07,1b,35)) { outValue = TokenType_obj::PLUS; return true; }
	if (inName==HX_("RBRACE",c1,eb,1a,00)) { outValue = TokenType_obj::RBRACE; return true; }
...
{
	if (inName==HX_("ARROW",a9,b1,7d,a3)) return 18;
	if (inName==HX_("BANG",b8,ab,d1,2b)) return 25;
	if (inName==HX_("COMMA",b5,69,4b,c8)) return 16;
	if (inName==HX_("EQEQ",d8,6b,d9,2d)) return 19;
	if (inName==HX_("EQUALS",3f,9a,75,72)) return 15;
	if (inName==HX_("GT",2d,3e,00,00)) return 21;
	if (inName==HX_("GTEQ",d9,1f,2e,2f)) return 22;
	if (inName==HX_("IDENTIFIER",69,3c,36,c0)) return 0;
	if (inName==HX_("KEYWORD",c9,1a,d1,3d)) return 1;
	if (inName==HX_("LBRACE",87,c1,f6,99)) return 12;
	if (inName==HX_("LBRACK",8d,c1,f6,99)) return 10;
	if (inName==HX_("LPAREN",1e,28,63,9e)) return 8;
	if (inName==HX_("LT",88,42,00,00)) return 23;
	if (inName==HX_("LTEQ",f4,30,7c,32)) return 24;
	if (inName==HX_("MINUS",50,b8,56,86)) return 5;
	if (inName==HX_("NOTEQ",1f,14,b9,1d)) return 20;
	if (inName==HX_("NUMBER",c9,32,fd,53)) return 2;
	if (inName==HX_("PERIOD",01,0d,9e,ed)) return 17;
	if (inName==HX_("PLUS",5a,07,1b,35)) return 4;
	if (inName==HX_("RBRACE",c1,eb,1a,00)) return 13;
	if (inName==HX_("RBRACK",c7,eb,1a,00)) return 11;
	if (inName==HX_("RPAREN",58,52,87,04)) return 9;
	if (inName==HX_("SEMICOLON",11,86,2a,49)) return 14;
...
int TokenType_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("LBRACE",87,c1,f6,99)) return 0;
	...
	if (inName==HX_("RBRACE",c1,eb,1a,00)) return 0;
...
::hx::Val TokenType_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("LBRACE",87,c1,f6,99)) return LBRACE;
	...
	if (inName==HX_("RBRACE",c1,eb,1a,00)) return RBRACE;
...
static ::String TokenType_obj_sStaticFields[] = {
	...
	HX_("LBRACE",87,c1,f6,99),
	HX_("RBRACE",c1,eb,1a,00),
...
{
ARROW = ::hx::CreateConstEnum< TokenType_obj >(HX_("ARROW",a9,b1,7d,a3),18);
BANG = ::hx::CreateConstEnum< TokenType_obj >(HX_("BANG",b8,ab,d1,2b),25);
COMMA = ::hx::CreateConstEnum< TokenType_obj >(HX_("COMMA",b5,69,4b,c8),16);
EQEQ = ::hx::CreateConstEnum< TokenType_obj >(HX_("EQEQ",d8,6b,d9,2d),19);
EQUALS = ::hx::CreateConstEnum< TokenType_obj >(HX_("EQUALS",3f,9a,75,72),15);
GT = ::hx::CreateConstEnum< TokenType_obj >(HX_("GT",2d,3e,00,00),21);
GTEQ = ::hx::CreateConstEnum< TokenType_obj >(HX_("GTEQ",d9,1f,2e,2f),22);
...
LBRACE = ::hx::CreateConstEnum< TokenType_obj >(HX_("LBRACE",87,c1,f6,99),12);
...
LT = ::hx::CreateConstEnum< TokenType_obj >(HX_("LT",88,42,00,00),23);
LTEQ = ::hx::CreateConstEnum< TokenType_obj >(HX_("LTEQ",f4,30,7c,32),24);
MINUS = ::hx::CreateConstEnum< TokenType_obj >(HX_("MINUS",50,b8,56,86),5);
NOTEQ = ::hx::CreateConstEnum< TokenType_obj >(HX_("NOTEQ",1f,14,b9,1d),20);
NUMBER = ::hx::CreateConstEnum< TokenType_obj >(HX_("NUMBER",c9,32,fd,53),2);
PERIOD = ::hx::CreateConstEnum< TokenType_obj >(HX_("PERIOD",01,0d,9e,ed),17);
PLUS = ::hx::CreateConstEnum< TokenType_obj >(HX_("PLUS",5a,07,1b,35),4);
RBRACE = ::hx::CreateConstEnum< TokenType_obj >(HX_("RBRACE",c1,eb,1a,00),13);
...
SEMICOLON = ::hx::CreateConstEnum< TokenType_obj >(HX_("SEMICOLON",11,86,2a,49),14);
