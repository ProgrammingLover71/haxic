...
void Lexer_obj::skipComments(){
            	HX_STACKFRAME(&_hx_pos_3dd68e9c2b948807_52_skipComments)
HXDLIN(  52)		if ((this->current == HX_("#",23,00,00,00))) {
HXLINE(  53)			while(true){
HXLINE(  53)				bool _hx_tmp;
HXDLIN(  53)				if (!(this->isEof())) {
HXLINE(  53)					_hx_tmp = (this->current != HX_("\n",0a,00,00,00));
            				}
            				else {
HXLINE(  53)					_hx_tmp = false;
            				}
HXDLIN(  53)				if (!(_hx_tmp)) {
HXLINE(  53)					goto _hx_goto_6;
            				}
HXLINE(  54)				this->advance();
            			}
            			_hx_goto_6:;
HXLINE(  56)			this->advance();
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC0(Lexer_obj,skipComments,(void))

::Array< ::Dynamic> Lexer_obj::tokenize(){
            	HX_GC_STACKFRAME(&_hx_pos_3dd68e9c2b948807_60_tokenize)
HXLINE(  61)		::Array< ::Dynamic> tokens = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  64)		while(!(this->isEof())){
HXLINE(  65)			this->skipWhitespace();
HXLINE(  66)			this->skipComments();
HXLINE(  67)			if (this->isEof()) {
HXLINE(  67)				goto _hx_goto_8;
            			}
HXLINE(  69)			::String _hx_switch_0 = this->current;
            			if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 133)				if ((this->peek() == HX_("=",3d,00,00,00))) {
HXLINE( 134)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::NOTEQ_dyn(),HX_("!=",fc,1c,00,00),this->line,this->column));
HXLINE( 135)					this->advance();
HXLINE( 136)					this->advance();
            				}
            				else {
HXLINE( 138)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::BANG_dyn(),this->current,this->line,this->column));
HXLINE( 139)					this->advance();
            				}
HXLINE( 133)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("\"",22,00,00,00)) ){
HXLINE( 149)				int start = (this->position + 1);
HXLINE( 150)				this->advance();
HXLINE( 151)				while(true){
HXLINE( 151)					bool _hx_tmp;
HXDLIN( 151)					if (!(this->isEof())) {
HXLINE( 151)						_hx_tmp = (this->current != HX_("\"",22,00,00,00));
            					}
            					else {
...
HXLINE( 152)					this->advance();
            				}
            				_hx_goto_13:;
HXLINE( 154)				if (this->isEof()) {
HXLINE( 154)					HX_STACK_DO_THROW((((HX_("Unterminated string literal at line ",3b,3a,7f,6b) + this->line) + HX_(", column ",96,fc,25,5b)) + this->column));
            				}
HXLINE( 155)				::String strValue = this->source.substring(start,this->position);
HXLINE( 156)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::STRING_dyn(),strValue,this->line,(this->column - ((this->position - start) + 1))));
HXLINE( 157)				this->advance();
HXLINE( 147)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("(",28,00,00,00)) ){
HXLINE(  83)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::LPAREN_dyn(),this->current,this->line,this->column));
HXLINE(  84)				this->advance();
HXLINE(  82)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_(")",29,00,00,00)) ){
HXLINE(  86)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::RPAREN_dyn(),this->current,this->line,this->column));
HXLINE(  87)				this->advance();
HXLINE(  85)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("*",2a,00,00,00)) ){
HXLINE(  77)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::STAR_dyn(),this->current,this->line,this->column));
HXLINE(  78)				this->advance();
HXLINE(  76)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("+",2b,00,00,00)) ){
HXLINE(  71)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::PLUS_dyn(),this->current,this->line,this->column));
HXLINE(  72)				this->advance();
HXLINE(  70)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_(",",2c,00,00,00)) ){
HXLINE( 142)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::COMMA_dyn(),this->current,this->line,this->column));
HXLINE( 143)				this->advance();
HXLINE( 141)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE(  74)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::MINUS_dyn(),this->current,this->line,this->column));
HXLINE(  75)				this->advance();
HXLINE(  73)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ){
HXLINE( 145)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::PERIOD_dyn(),this->current,this->line,this->column));
HXLINE( 146)				this->advance();
HXLINE( 144)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("/",2f,00,00,00)) ){
HXLINE(  80)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::SLASH_dyn(),this->current,this->line,this->column));
HXLINE(  81)				this->advance();
HXLINE(  79)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_(";",3b,00,00,00)) ){
HXLINE( 101)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::SEMICOLON_dyn(),this->current,this->line,this->column));
HXLINE( 102)				this->advance();
HXLINE( 100)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("<",3c,00,00,00)) ){
HXLINE( 124)				if ((this->peek() == HX_("=",3d,00,00,00))) {
HXLINE( 125)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::LTEQ_dyn(),HX_("<=",81,34,00,00),this->line,this->column));
HXLINE( 126)					this->advance();
HXLINE( 127)					this->advance();
            				}
            				else {
HXLINE( 129)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::LT_dyn(),this->current,this->line,this->column));
HXLINE( 130)					this->advance();
            				}
HXLINE( 124)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("=",3d,00,00,00)) ){
HXLINE( 104)				this->advance();
HXLINE( 105)				if ((this->peek() == HX_("=",3d,00,00,00))) {
HXLINE( 106)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::EQEQ_dyn(),HX_("==",60,35,00,00),this->line,this->column));
HXLINE( 107)					this->advance();
            				}
            				else {
HXLINE( 108)					if ((this->peek() == HX_(">",3e,00,00,00))) {
HXLINE( 109)						tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::ARROW_dyn(),HX_("=>",61,35,00,00),this->line,this->column));
HXLINE( 110)						this->advance();
            					}
            					else {
HXLINE( 112)						tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::EQUALS_dyn(),this->current,this->line,this->column));
            					}
            				}
HXLINE( 103)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_(">",3e,00,00,00)) ){
HXLINE( 115)				if ((this->peek() == HX_("=",3d,00,00,00))) {
HXLINE( 116)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::GTEQ_dyn(),HX_(">=",3f,36,00,00),this->line,this->column));
HXLINE( 117)					this->advance();
HXLINE( 118)					this->advance();
            				}
            				else {
HXLINE( 120)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::GT_dyn(),this->current,this->line,this->column));
HXLINE( 121)					this->advance();
            				}
HXLINE( 115)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("[",5b,00,00,00)) ){
HXLINE(  89)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::LBRACK_dyn(),this->current,this->line,this->column));
HXLINE(  90)				this->advance();
HXLINE(  88)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("]",5d,00,00,00)) ){
HXLINE(  92)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::RBRACK_dyn(),this->current,this->line,this->column));
HXLINE(  93)				this->advance();
HXLINE(  91)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("{",7b,00,00,00)) ){
HXLINE(  95)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::LBRACE_dyn(),this->current,this->line,this->column));
HXLINE(  96)				this->advance();
HXLINE(  94)				goto _hx_goto_12;
            			}
            			if (  (_hx_switch_0==HX_("}",7d,00,00,00)) ){
HXLINE(  98)				tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::RBRACE_dyn(),this->current,this->line,this->column));
HXLINE(  99)				this->advance();
HXLINE(  97)				goto _hx_goto_12;
            			}
            			/* default */{
HXLINE( 160)				if ( ::EReg_obj::__alloc( HX_CTX ,HX_("[a-zA-Z_$$]",79,b2,ba,9f),HX_("",00,00,00,00))->match(this->current)) {
HXLINE( 161)					int start1 = this->position;
HXLINE( 162)					while(true){
HXLINE( 162)						bool _hx_tmp1;
HXDLIN( 162)						if (!(this->isEof())) {
HXLINE( 162)							_hx_tmp1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[a-zA-Z0-9_$$]",bf,dd,18,78),HX_("",00,00,00,00))->match(this->current);
            						}
            						else {
HXLINE( 162)							_hx_tmp1 = false;
            						}
HXDLIN( 162)						if (!(_hx_tmp1)) {
HXLINE( 162)							goto _hx_goto_9;
            						}
HXLINE( 163)						this->advance();
            					}
            					_hx_goto_9:;
HXLINE( 165)					::String identifier = this->source.substring(start1,this->position);
HXLINE( 166)					 ::src::TokenType type;
HXDLIN( 166)					if (this->isKeyword(identifier)) {
HXLINE( 166)						type = ::src::TokenType_obj::KEYWORD_dyn();
            					}
            					else {
HXLINE( 166)						type = ::src::TokenType_obj::IDENTIFIER_dyn();
            					}
HXLINE( 167)					tokens->push( ::src::Token_obj::__alloc( HX_CTX ,type,identifier,this->line,this->column));
            				}
            				else {
HXLINE( 168)					if ( ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9]",1c,5f,53,85),HX_("",00,00,00,00))->match(this->current)) {
HXLINE( 169)						int start2 = this->position;
HXLINE( 170)						while(true){
HXLINE( 170)							bool _hx_tmp2;
HXDLIN( 170)							if (!(this->isEof())) {
HXLINE( 170)								_hx_tmp2 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9]",1c,5f,53,85),HX_("",00,00,00,00))->match(this->current);
            							}
            							else {
...
HXLINE( 171)							this->advance();
            						}
            						_hx_goto_10:;
HXLINE( 173)						if ((this->current == HX_(".",2e,00,00,00))) {
HXLINE( 174)							this->advance();
HXLINE( 175)							while(true){
HXLINE( 175)								bool _hx_tmp3;
HXDLIN( 175)								if (!(this->isEof())) {
HXLINE( 175)									_hx_tmp3 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[0-9]",1c,5f,53,85),HX_("",00,00,00,00))->match(this->current);
            								}
            								else {
HXLINE( 175)									_hx_tmp3 = false;
            								}
HXDLIN( 175)								if (!(_hx_tmp3)) {
HXLINE( 175)									goto _hx_goto_11;
            								}
HXLINE( 176)								this->advance();
            							}
            							_hx_goto_11:;
            						}
HXLINE( 179)						::String numberStr = this->source.substring(start2,this->position);
HXLINE( 180)						tokens->push( ::src::Token_obj::__alloc( HX_CTX ,::src::TokenType_obj::NUMBER_dyn(),numberStr,this->line,(this->column - (this->position - start2))));
            					}
            					else {
HXLINE( 183)						HX_STACK_DO_THROW((((((HX_("Unknown character: ",d9,80,f1,ed) + this->current) + HX_(" at line ",df,96,71,22)) + this->line) + HX_(", column ",96,fc,25,5b)) + this->column));
            					}
            				}
            			}
            			_hx_goto_12:;
...
::hx::Val Lexer_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"skipComments") ) { return ::hx::Val( skipComments_dyn() ); }
		break;
	case 14:
