...
::hx::ObjectPtr< Return_obj > Return_obj::__new( ::src::types::Value value) {
	::hx::ObjectPtr< Return_obj > __this = new Return_obj();
	__this->__construct(value);
	return __this;
}

::hx::ObjectPtr< Return_obj > Return_obj::__alloc(::hx::Ctx *_hx_ctx, ::src::types::Value value) {
...
::hx::Val Return_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"value") ) { value=inValue.Cast<  ::src::types::Value >(); return inValue; }
	}
...
static ::hx::StorageInfo Return_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::src::types::Value */ ,(int)offsetof(Return_obj,value),HX_("value",71,7f,b8,31)},
	{ ::hx::fsUnknown, 0, null()}
};
